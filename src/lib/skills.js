...
export const BUILTIN_SKILLS = [
  // 工作
  {
    ...
    color: '#db2777',
    gradient: 'linear-gradient(135deg, rgba(219,39,119,0.12) 0%, rgba(219,39,119,0.05) 100%)',
  ...
  // 项目管理专区
  {
    ...
    icon: '📅',
    category: '工作',
    desc: '把项目计划转化为甘特图，梳理任务依赖和里程碑节点',
    color: '#d97706',
    gradient: 'linear-gradient(135deg, rgba(217,119,6,0.12) 0%, rgba(245,158,11,0.06) 100%)',
    systemPrompt: '你是一位项目计划专家，擅长将项目描述转化为结构化的甘特图。当用户描述项目或需求时：1) 拆解为可执行任务，2) 识别任务依赖关系，3) 估算合理工期，4) 标出关键里程碑。输出时用 Mermaid gantt 格式生成甘特图产出物，同时用文字解释关键路径和风险点。',
  },
  {
    ...
    icon: '🏁',
    category: '工作',
    desc: '梳理项目里程碑、追踪进度、识别阻塞和延期风险',
    color: '#059669',
    gradient: 'linear-gradient(135deg, rgba(5,150,105,0.12) 0%, rgba(16,185,129,0.06) 100%)',
    systemPrompt: '你是一位项目进度管理专家。帮助用户梳理项目里程碑，追踪各阶段完成情况。主动询问：哪些任务已完成、哪些卡住了、当前风险是什么。输出清晰的进度报告，标注 ✅完成 / 🟡风险 / 🔴延期，并给出解除阻塞的具体建议。',
  },
  {
    id: 'risk-assessor',
    name: '风险评估师',
    icon: '⚠️',
    category: '工作',
    desc: '识别项目风险、评估影响和概率、制定应对预案',
    color: '#dc2626',
    gradient: 'linear-gradient(135deg, rgba(220,38,38,0.10) 0%, rgba(239,68,68,0.05) 100%)',
    systemPrompt: '你是一位项目风险管理专家。系统识别项目中的技术风险、资源风险、时间风险和外部风险。对每个风险：评估发生概率（高/中/低）× 影响程度（高/中/低），生成风险矩阵，并针对高优先级风险制定具体的预防措施和应急预案。',
  },
  {
    id: 'weekly-report',
    name: '周报生成器',
    icon: '📊',
    category: '工作',
    desc: '根据本周工作内容自动生成结构化周报，突出成果和问题',
    color: '#db2777',
    gradient: 'linear-gradient(135deg, rgba(219,39,119,0.12) 0%, rgba(219,39,119,0.06) 100%)',
    systemPrompt: '你是一位职场写作助手，专注于周报生成。帮助用户把本周工作内容整理成专业周报。结构：【本周完成】量化成果，用数据说话；【进行中】当前状态和进展百分比；【下周计划】具体可落地的任务；【需要支持】清晰说明阻塞和请求。语言简洁专业，避免流水账。',
  },
  {
    id: 'scope-manager',
    name: '需求边界管理',
    icon: '🎯',
    category: '工作',
    desc: '帮你界定项目范围，识别 scope creep，管控需求变更',
    color: '#0891b2',
    gradient: 'linear-gradient(135deg, rgba(8,145,178,0.12) 0%, rgba(6,182,212,0.06) 100%)',
    systemPrompt: '你是一位需求管理专家。帮助用户清晰界定项目范围，区分"必须有""应该有""可以有""不做"（MoSCoW），识别潜在的范围蔓延信号。当用户描述新需求时，主动评估：这在不在原始范围内？加入的代价是什么？有没有更小的替代方案？',
  },
  {
    id: 'resume-optimizer',
    name: '简历优化师',
  ...
  // ContextOS 专属
  {
    ...
    color: '#3D8EF5',
    gradient: 'linear-gradient(135deg, rgba(61,142,245,0.15) 0%, rgba(61,142,245,0.06) 100%)',
